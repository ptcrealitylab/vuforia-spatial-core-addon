...
/**
 * @fileOverview
 * RECEIVE-POST is a block that can be triggered from an external service making a POST request to this block's endpoint
 * @todo: implementation is in a different branch, needs to be copied in here
 *
...
exports.render = function (object, frame, node, block, index, thisBlock, callback, utilities) {
    // data flows through this block like normal (but it also has an IP address where you can post to it directly)
